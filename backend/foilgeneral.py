...
class Airfoil(gmt.GeoShape):
    ...
    def default_state(self, transform = True) -> list:
        """
...
def crv2gs(curvesls) -> list:
    ...
    for curves in curvesls:
        ...
        gsl.append(gmt.GeoShape(points, squencs, shapes))
...
def sides_populate(afl: Airfoil, n) -> list:
    """
...
def hld_gen(afl: Airfoil, func, args) -> list:
    """
